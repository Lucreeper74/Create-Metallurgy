...
import static fr.lucreeper74.createmetallurgy.content.processing.glassedcastingtop.GlassedCastingTopBlock.UNDER_FOUNDRY_MIXER;
...
public class AnimatedFoundryMixer extends AnimatedKinetics {
    ...
    public void draw(PoseStack matrixStack, int xOffset, int yOffset) {
        ...
        blockElement(AllBlocks.GLASSED_FOUNDRY_TOP_BLOCK.getDefaultState().setValue(UNDER_FOUNDRY_MIXER, true))
                .atLocal(0, .65, 0)
                .scale(scale)
                .render(matrixStack);
