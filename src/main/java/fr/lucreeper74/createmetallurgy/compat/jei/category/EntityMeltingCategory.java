...
public class EntityMeltingCategory extends FoundryAbstractCategory<MobMeltingRecipe> {
    private final FoundryElement foundry = new FoundryElement();

    public EntityMeltingCategory(Info<MobMeltingRecipe> info) {
        super(info);
    }

    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, MobMeltingRecipe recipe, IFocusGroup focuses) {
    ...
    @Override
    public void draw(MobMeltingRecipe recipe, IRecipeSlotsView iRecipeSlotsView, GuiGraphics graphics, double mouseX, double mouseY) {
