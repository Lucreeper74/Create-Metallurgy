...
public class CrucibleScenes {
    ...
    public static void crucible(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(crucibleController, Direction.WEST), Pointing.LEFT).rightClick()
    ...
    public static void foundry(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(util.grid.at(3, 1, 2), Direction.NORTH), Pointing.RIGHT).rightClick()
                .withItem(CMItems.FOUNDRY_UNIT.asStack()), 15);
        scene.idle(7);
        ...
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(util.grid.at(2, 1, 2), Direction.WEST), Pointing.LEFT).rightClick()
                .withItem(AllItems.BLAZE_CAKE.asStack()), 15);
        scene.idle(10);
