...
public class CMDatagen {
    ...
    public static void gatherDataHighPriority(GatherDataEvent event) {
        if (event.getMods().contains(CreateMetallurgy.MOD_ID))
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        CMGenEntriesProvider generatedEntriesProvider = new CMGenEntriesProvider(output, lookupProvider);
        ...
        if (event.includeServer()) {
            CMRecipeProvider.registerAllProcessing(gen, output, lookupProvider);
        }
    }
