...
import fr.lucreeper74.createmetallurgy.worldgen.CMBiomeModifiers;
import fr.lucreeper74.createmetallurgy.worldgen.CMConfiguredFeatures;
import fr.lucreeper74.createmetallurgy.worldgen.CMPlacedFeatures;
...
public class CMGenEntriesProvider extends DatapackBuiltinEntriesProvider {
    ...
    public static final RegistrySetBuilder BUILDER = new RegistrySetBuilder()
            ...
            .add(NeoForgeRegistries.Keys.BIOME_MODIFIERS, CMBiomeModifiers::bootstrap)
