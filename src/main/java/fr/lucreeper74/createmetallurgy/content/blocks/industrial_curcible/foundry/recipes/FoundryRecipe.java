...
import fr.lucreeper74.createmetallurgy.content.blocks.industrial_curcible.foundry.MeltingInventory;
...
public class FoundryRecipe extends ProcessingRecipe<SmartInventory> {
    ...
    public static boolean match(CurcibleBlockEntity be, Recipe<?> recipe) {
    ...
    public static boolean isEnoughHeated(CurcibleBlockEntity ladle, ProcessingRecipe<?> recipe) {
        if (recipe == null)
            return false;
