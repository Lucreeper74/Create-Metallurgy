...
import fr.lucreeper74.createmetallurgy.content.light_bulb.network.INetworkNode;
...
public class NetworkAddressBehaviour extends BlockEntityBehaviour implements INetworkNode, ClipboardCloneable {
    ...
    public boolean testHit(Vec3 hit) {
        ...
        return slot.testHit(blockEntity.getLevel(), blockEntity.getBlockPos(), state, localHit);
    }
