...
public class CastingWithSpout implements BlockSpoutingBehaviour {
    ...
    public static void registerDefaults() {
        BY_BLOCK_ENTITY.register(CMBlockEntityTypes.CASTING_TABLE.get(), new CastingWithSpout());
        BY_BLOCK_ENTITY.register(CMBlockEntityTypes.CASTING_BASIN.get(), new CastingWithSpout());
    }
}